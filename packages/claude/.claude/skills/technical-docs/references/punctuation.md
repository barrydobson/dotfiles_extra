...
- For a break in a sentence, use a spaced hyphen ( - ). Never an em dash.
...
- Don't put important information in parentheses - readers skip it. Prefer commas, a spaced hyphen, or a separate sentence.
