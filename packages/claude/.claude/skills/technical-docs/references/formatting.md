...
- Introduce short examples with "such as," "for example," or "like," set off by a comma, a spaced hyphen, or parentheses - not a semicolon.
...
- Flag surprising behaviour in the text: downloads, same-page jumps, cross-domain targets ("see OS-level virtualization (Wikipedia)").
