...
| Terms being defined; words as words                                               | _Italic_                                                               |
| Titles of full-length works (unlinked)                                            | _Italic_                                                               |
...
| Placeholders                                                                      | `ALL_CAPS` code font, italic where markdown allows: _`PROJECT_ID`_     |
| Code blocks                                                                       | Fenced code block                                                      |
| Headings, titles, table headers, captions                                         | Sentence case                                                          |
| Emphasis (rare)                                                                   | _Italic_, never bold or underline                                      |
